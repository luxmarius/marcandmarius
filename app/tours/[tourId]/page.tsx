...
export default function TourDetailPage({ params }: { params: Params }) {
  ...
  return (
    <div className="bg-background text-surface min-h-[60vh]">
      <section className="pt-24 pb-12">
        <div className={container}>
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="flex flex-wrap gap-3 text-sm text-background">
            ...
            <a
              href={tour.gpxUrl}
              className="inline-flex items-center gap-2 rounded-xl bg-primary text-background px-5 py-2 text-sm font-semibold hover:bg-primary/80"
            >
      ...
      <section className="pb-20">
        <div className={container}>
          <div className="rounded-3xl bg-surface/5 ring-1 ring-primary/20 p-10 text-background space-y-4">
            <h2 className="text-2xl font-semibold text-surface">What to expect</h2>
            <p className="text-sm opacity-80 text-surface/90">
...
function Stat({
  ...
  return (
    <div className="inline-flex items-center gap-2 rounded-full bg-surface/20 px-3 py-1 text-xs uppercase tracking-wide text-surface/90">
